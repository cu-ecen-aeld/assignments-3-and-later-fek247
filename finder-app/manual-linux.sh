...
set +e
cp -a $SYSROOT/lib64/ld-*.so ${OUTDIR}/rootfs/lib64/ 2>/dev/null
cp -a $SYSROOT/lib64/libc-*.so ${OUTDIR}/rootfs/lib64/ 2>/dev/null
cp -a $SYSROOT/lib64/libm-*.so ${OUTDIR}/rootfs/lib64/ 2>/dev/null
cp -a $SYSROOT/lib64/libresolv-*.so ${OUTDIR}/rootfs/lib64/ 2>/dev/null
set -e
